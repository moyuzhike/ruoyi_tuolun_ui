<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="finishedList" border @selection-change="handleSelectionChange">
      ...
      <el-table-column label="流程状态" align="center" prop="tugFeeVo.state" width="180"/>
...
<script>
  import { adminfinishedList, getDeployment, delDeployment, addDeployment, updateDeployment, exportDeployment } from "@/api/flowable/finished";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        //   this.loading = false;
        // });
        adminfinishedList(this.queryParams).then(response => {
          this.finishedList = response.data.records;
          this.total = response.data.total;
          this.loading = false;
        });
